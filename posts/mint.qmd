...
5.  Hold the fn and f12 keys until BIOS menu is open
...
Switch on the PC after holding fn and f12 as before to reach BIOS setting. Now click on the USB UEFI to boot from it. The PC will boot from USB to Linux Mint.
