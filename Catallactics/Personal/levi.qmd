...
Now we sum all these mutually exclusive probabilities[^1]:

[^1]: Sum = 0.0648 + 0.0754 + 0.0795 + 0.0829 + 0.0952 + 0.1155 + 0.1626 + 0.3241 = 0.9999

-   **P(Return \< -60)**: 0.0648

-   **P(-60 ≤ Return \< -30)**: 0.0754

-   **P(-30 ≤ Return \< -15)**: 0.0795

-   **P(-15 ≤ Return \< -5)**: 0.0829

-   **P(-5 ≤ Return \< 5)**: 0.0952

-   **P(5 ≤ Return \< 15)**: 0.1155

-   **P(15 ≤ Return \< 30)**: 0.1626
