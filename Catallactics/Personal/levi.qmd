...
In summary, the simulated returns indicate a distribution centered around a mean of approximately 11.09, with a minimum truncated value of -100 and a maximum value of 505.309.

The probability calculations reveal that there is a:

-   31.53% chance that the return will exceed 15,

-   3.81% chance that the return will exceed 30,

-   46.62% chance that the return will fall between 5 and 15,

-   27.72% chance that the return will fall between 15 and 30,

-   16.21% chance that the return will fall between -5 and 5,

-   3.06% chance that the return will fall between -15 and -5,

-   2.58% chance that the return will be less than -15,

-   1.26% chance that the return will be less than -30, and

-   0.58% chance that the return will be less than -60.
