---
title: Risk
subtitle: Market risk is not the only risk
comments: 
  hypothesis: true
...
This average return cleverly hides other important risks: [**volatility risk**](https://www.knotes.co.in/catallactics/personal/volatility)**, inaction risk** and **sequence of return risk**. They require a little explanation to understand their true impact on us.
...
What if we withdraw or add a fixed percentage instead of a fixed amount? When exactly in your life cycle does sequence of return risk bites you most? see [sequence of return risk](https://www.knotes.co.in/catallactics/personal/sequence2)
