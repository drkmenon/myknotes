...
Modern portfolio theory attempts to address this problem of volatility by diversification and proposes Sharpe ratio to evaluate the risk adjusted return of the portfolio. It reduces the downward volatility to some extend; but in doing so it also reduces the favourable upward movements, prescribing a cure costlier than the disease.
