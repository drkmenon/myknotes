...
Aim for a strike **less than 10 delta.**
...
```{r}
closing<-22530
strikerate <- 18000  # Strike price of the option
...
For the hedging to outperform a pure buy and hold strategy with out hedging, it should be mortised at 8- 10 times the initial premium or a catastrophy should happen. In any case, the proceedings should be used to buy further far OTM puts and rest may be invested in the crashing asset.
