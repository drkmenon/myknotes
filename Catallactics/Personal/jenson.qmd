...
## What is convex position?

Any activity that result in unlimited potential upside with a limited quantifiable downside can be called convex. Eg: Learning, writing a book, research, start-ups and buying derivatives are similar; they are all convex. Risk of failure is high, but the reward one may recieve if successful will be life changing.
