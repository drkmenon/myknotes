...
This average return cleverly hides two other important risks: **volatility risk** and **sequence of return risk**. Both require a little explanation to understand their true impact on us.
...
What if we withdraw or add a fixed percentage instead of a fixed amount? When exactly in your life cycle does sequence of return risk bites you most? These and the other two risks can be discussed in upcoming articles.
