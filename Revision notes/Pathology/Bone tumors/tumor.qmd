...
|-------|-----------|-------------|----------|----------------|
| 1a    | Low (G1)  | IC (T0)     | M0       | G1, T0, M0     |
| 1b    | Low (G1)  | EC (T1)     | M0       | G1, T1, M0     |
| 2a    | High (G2) | IC (T0)     | M0       | G2, T0, M0     |
| 2b    | High (G2) | EC (T1)     | M0       | G2, T1, M0     |
| 3a    | Any       | IC (T0)     | M1       | G1/2, T0, M1   |
| 3b    | Any       | EC (T1)     | M1       | G1/2, T1, M1   |

-   Stages 1 are all low grade
-   Stage 2 are all high grade
-   Stages 3 all have metastases
