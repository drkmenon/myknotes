...
Having added the first search term, we may add the second search term, say "Shoulder" using any of the 3 Boolean operators of our choice. We can gradually build the search keywords by adding more and more terms to the query.
