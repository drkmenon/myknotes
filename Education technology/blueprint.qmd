...
```{r echo=FALSE}
library(checkdown)
check_question(answer = "Curriculum", right = "correct",wrong = "try again",options = c("Curriculum","Syllabus","Blueprint","Assessment"),type =   "radio",alignment = "horizontal",random_answer_order = T,title = "A prescribed path to be followed by student is called")
```

### Result

`r insert_score()` out of 1
