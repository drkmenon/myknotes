---
title: "Passing MS Orthopaedics somehow"
subtitle: "....is not the real goal"
order: 3
format:
  revealjs:
...
-   MBBS turns some of the brightest minds into dumb automatons.

-   A specialty degree reinforces this automation to the level of slavery, adding two more misguided believes:

    1.  "Prostitution is acceptable as long as it pays."\
    2.  "Your professional practice is nothing more than a prostitution."

They seek indulgence, striving to "enjoy every moment," chasing that extra surge of dopamine.

They learn to engage in autistic exchanges to sustain this lifestyle, **all while convincing themselves, deep down, that it is normal and even admirable as a sure sign of success.**

You need a lot of courage and conviction to remain chaste even after 8–9 years of intense grind.

## Time, 2^nd^ order thinking and Effect horizon: Animal ➤ MAN

![\@Sam Ovens](images/effect.png){width="699"}
...
-   Have core principles

## Build and apply mental maps

-   Have goal

-   Think long term

-   Develop 2^nd^ order thinking skills
:::
