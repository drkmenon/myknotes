...
-   **For online distribution** (on websites or otherwise):\
...
-   **For inline quizzes on a webpage:**\
    ...
    `r forms_schoice(c(“choice 1”, “choice 2”, “choice 3”, “choice 4”),
    c(TRUE, FALSE, FALSE, FALSE), display = “dropdown”)`
    
    `r forms_mchoice(c(“choice 1”, “choice 2”, “choice 3”, “choice 4”),
    c(TRUE, FALSE, FALSE, TRUE), display = “dropdown”)`
